...
<#--    BizNewsList-->
    <@articleTag method="BizNewsList" pageSize="5">
        <#if BizNewsList?? && (BizNewsList?size > 0)>
            <div class="blog-body expansion biznews" style="padding: 0;margin-bottom: 1%;">
                        ...
                        <article class="fade-in">
                            ...
                            <header class="entry-header">
                                ...
                                <h2 class="entry-title">
                                    <a href="${config.siteUrl}/article/${item.id?c}" rel="bookmark"
                                       title="${item.title}" data-toggle="tooltip"
                            ...
                            <div class="entry-content">
                                ...
                                <span class="views" title="文章阅读次数" data-toggle="tooltip" data-placement="bottom"><i
                                            class="fa fa-eye fa-fw"></i>${item.lookCount!(0)}</span>
                    ...
                    <article class="fade-in" style="height: auto">
                        ...
                        <form action="/" method="post" class="form-horizontal searchForm">
                            ...
                            <ul class="list-unstyled list-inline search-hot">
                                ...
                                <li><a class="pointer" rel="external nofollow"><span class="label label-primary">Springboot</span></a>
                                </li>
                                <li><a class="pointer" rel="external nofollow"><span
                                                class="label label-success">Linux</span></a></li>
                                <li><a class="pointer" rel="external nofollow"><span
                                                class="label label-info">Maven</span></a></li>
                                <li><a class="pointer" rel="external nofollow"><span class="label label-warning">Bootstrap</span></a>
                                </li>
                                <li><a class="pointer" rel="external nofollow"><span
