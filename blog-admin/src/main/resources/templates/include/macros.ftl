            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="https://dancoder.oss-cn-shanghai.aliyuncs.com/oneblog/20190815234750889.png" alt="..." class="img-circle profile_img">
                    </div>
                    ...
                    <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <fieldset>
                            ...
                            <ul>
                                ...
                                <li>留言：<a href="https://www.dancoder.cn/guestbook" target="_blank">https://www.dancoder.cn/guestbook</a></li>
                    ...
                    <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <fieldset>
                            ...
                            <ul>
                                ...
                                <li><span><span><strong>实时通讯</strong>：管理员可向在线的用户发送实时消息（需用户授权 - 基于websocket实现，具体参考<a href="https://www.dancoder.cn/article/111">DBlog建站之Websocket的使用</a>）</span></span></li>
