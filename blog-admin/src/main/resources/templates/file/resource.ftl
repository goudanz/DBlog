            ...
            <div class="x_content">
                <div class="btn-group hidden-xs" id="toolbar" style="padding: 10px 0;">
                    <@shiro.hasPermission name="files">
                        <button id="btn_add" type="button" class="btn btn-info" title="新增资源文件">
...
<@addOrUpdateMOdal defaultTitle="添加文件">
    <div class="item form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="url">选择文件 <span class="required">*</span></label>
    ...
    <script>
        ...
        $(function () {
            ...
            function loadData(pageNumber){
                $.ajax({
                    url: "/file/list/resource",
                    data: {pageNumber: pageNumber},
                    type: "POST",
                    success: function (json) {
                        var tpl = '{{#list}}<div class="col-md-55">\n' +
                                '                    <div class="thumbnail" style="height:40px;">\n' +
                                '                        <div style="height:0px;" class="image view view-first pointer file-item">\n' +
